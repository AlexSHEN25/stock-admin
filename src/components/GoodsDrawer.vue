    ...
    <a-spin :spinning="loading">
      <a-form layout="vertical">
        ...
        <a-row :gutter="12">
          ...
          <a-col :span="12">
            <a-form-item label="品名">
              <a-input v-model:value="form.skuName" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item
        ...
        <a-row :gutter="12">
          ...
          <a-col :span="12">
            <a-form-item label="改定価格">
              <a-input-number
                v-model:value="form.updatePrice"
                :min="0.01"
                :precision="2"
                style="width:100%"
              />
          ...
          <a-col :span="12">
            <a-form-item :label="'価格更新日時' + (form.updatePrice ? ' *' : '')">
              <a-date-picker
                v-model:value="form.priceUpdateTime"
