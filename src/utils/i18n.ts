...
const MESSAGES: Record<AppLang, Dict> = {
  'zh-CN': {
    ...
    'menu.user.userRole': '用户角色',
    'menu.user.rolePermission': '角色权限',
    'menu.user.dept': '部门管理',
    'menu.user.userToken': '登录令牌',
    'menu.goods': '商品管理',
    'menu.goods.goods': '商品管理',
    'menu.goods.brand': '品牌管理',
    'menu.goods.series': '系列管理',
    'menu.goods.goodsType': '商品类型',
    'menu.goods.maker': '产地管理',
    'menu.stock': '库存管理',
    'menu.stock.stock': '库存管理',
    'menu.stock.stockOrder': '出入库单',
    'menu.stock.stockOrderItem': '出入库明细',
    'menu.stock.stockRecord': '库存流水',
    'menu.stock.priceRecord': '价格记录',
    'menu.stock.warehouse': '仓库管理',
    'menu.request': '请求书管理',
    'menu.request.requestForm': '请领单',
    'menu.request.requestItem': '请领明细',
    'menu.customer': '客户管理',
    'menu.customer.customer': '客户管理',
    'menu.customer.customerLevel': '客户等级',
    'menu.system': '系统配置',
  ...
  'en-US': {
    ...
    'menu.stock.priceRecord': 'Price Records',
